...
bp = Piece('b', 'p', 'b-pawn.png')
wp = Piece('w', 'p', 'b-pawn.png')
bk = Piece('b', 'k', 'b-pawn.png')
wk = Piece('w', 'k', 'b-pawn.png')
br = Piece('b', 'r', 'b-pawn.png')
wr = Piece('w', 'r', 'b-pawn.png')
bb = Piece('b', 'b', 'b-pawn.png')
wb = Piece('w', 'b', 'b-pawn.png')
bq = Piece('b', 'q', 'b-pawn.png')
wq = Piece('w', 'q', 'b-pawn.png')
bkn = Piece('b', 'kn', 'b-pawn.png')
wkn = Piece('w', 'kn', 'b-pawn.png')
